...
public class ArticleDetailFragment extends Fragment implements
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
        ...
        if (mMaxScrollRange + i == 0) {
            mCollapsingToolbar.setTitle(mTitle);
            mCollapsingToolbar.setCollapsedTitleTypeface(Typeface.createFromAsset(getResources().getAssets(), "nevis.ttf"));
            mIsTitleShown = true;
            mToolbar.setBackgroundColor(mMutedColor);
        } else if(mIsTitleShown) {
            mCollapsingToolbar.setTitle("");
            mIsTitleShown = false;
            mToolbar.setBackgroundColor(getResources().getColor(R.color.transprent));
        }
